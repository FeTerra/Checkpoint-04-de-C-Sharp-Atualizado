    ...
    public partial class CriacaoInicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RM99405_Fornecedor", x => x.idFornecedor);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RM99405_Pedido", x => x.idPedido);
                });

            migrationBuilder.CreateTable(
                name: "RM99405_Produto",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RM99405_Produto", x => x.idProduto);
                });
        }
